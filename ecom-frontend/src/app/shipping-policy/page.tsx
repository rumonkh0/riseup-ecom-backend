...
export default function ShippingPolicy() {
  ...
  const icons = [
    <Clock key="0" className="text-warm-500 flex-shrink-0 mt-0.5" size={20} />,
    <MapPin key="1" className="text-warm-500 flex-shrink-0 mt-0.5" size={20} />,
    <ShieldCheck key="2" className="text-warm-500 flex-shrink-0 mt-0.5" size={20} />
  ];
    ...
    <div className="min-h-screen bg-cream">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="bg-white rounded-3xl p-8 border border-warm-100 shadow-sm space-y-8 text-navy-light/80 leading-relaxed text-sm">
          {t.shipping.sections.map((section, idx) => (
