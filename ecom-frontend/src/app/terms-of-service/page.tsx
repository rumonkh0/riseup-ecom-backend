...
export default function TermsOfService() {
  ...
  const icons = [
    <Scale key="0" className="text-warm-500 flex-shrink-0 mt-0.5" size={20} />,
    <AlertTriangle key="1" className="text-warm-500 flex-shrink-0 mt-0.5" size={20} />,
